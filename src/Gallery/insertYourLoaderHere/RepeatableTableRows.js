      ...
      {[...Array(rows)].map((el, index) => {
        ...
        return (
          <Fragment key={index}>
            ...
            <rect x="0" y={contentVerticalPosition(59)} x="10" ry="10" width="1500" height="1"
            />
          </Fragment>
        );
      })}
...
RepeatableTableRows.metadata = {
  ...
  github: "sherpaPSX",
  description:
    "Repeatable table rows. You can easly define number of rows in props and generate then in one svg",
